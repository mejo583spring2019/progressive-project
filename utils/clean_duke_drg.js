...
function main() {
  ...
  data.forEach(r => {
    ...
    if (r.insured_avg_patient_resposibility === "-") {
      r.insured_avg_patient_resposibility = "0";
    }
    if (r.uninsured_avg_patient_resposibility === "-") {
      r.uninsured_avg_patient_resposibility = "0";
    }
